...
public class FilmraryDbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        String SQL_CREATE_FILMS_TABLE = "CREATE TABLE " + Films.TABLE_NAME + "("
                                        + Films._ID + " INTEGER PRIMARY KEY AUTOINCREMENT, "
                                        + Films.COLUMN_NAME + " TEXT NOT NULL, "
                                        + Films.COLUMN_YEAR + " INTEGER NOT NULL, "
        ...
        String SQL_CREATE_ACTORS_TABLE = "CREATE TABLE " + Actors.TABLE_NAME + "("
        ...
        String SQL_CREATE_ACTOR_FILM_TABLE =
                "CREATE TABLE " + ActorFilm.TABLE_NAME + "("
        ...
        String SQL_CREATE_COUNTRIES_TABLE = "CREATE TABLE " + Countries.TABLE_NAME + "("
                                            + Countries._ID + " INTEGER PRIMARY KEY AUTOINCREMENT, "
                                            + Countries.COLUMN_NAME + " TEXT NOT NULL" + ")";

        String SQL_CREATE_COUNTRY_FILM_TABLE = "CREATE TABLE " + CountryFilm.TABLE_NAME + "("
        ...
        String SQL_CREATE_GANRES_TABLE = "CREATE TABLE " + Genres.TABLE_NAME + "("
                                         + Genres._ID + " INTEGER PRIMARY KEY AUTOINCREMENT, "
                                         + Genres.COLUMN_NAME + " TEXT NOT NULL, "
                                         + Genres.COLUMN_INFO + " TEXT" + ")";

        String SQL_CREATE_GANRE_FILM_TABLE = "CREATE TABLE " + GenreFilm.TABLE_NAME + "("
        ...
        String SQL_CREATE_PRODUCERS_TABLE = "CREATE TABLE " + Producers.TABLE_NAME + "("
        ...
        String SQL_CREATE_PRODUCER_FILM_TABLE = "CREATE TABLE " + ProducerFilm.TABLE_NAME + "("
        ...
        String SQL_CREATE_WANT_TO_WATCH_TABLE = "CREATE TABLE " + WantToWatch.TABLE_NAME + "("
        ...
        String SQL_CREATE_WATCHED_TABLE = "CREATE TABLE " + Watched.TABLE_NAME + "("
        ...
        String SQL_CREATE_SERIAS_TABLE = "CREATE TABLE " + Series.TABLE_NAME + "("
        ...
        String SQL_CREATE_ACTOR_SERIAS_TABLE = "CREATE TABLE " + ActorSeries.TABLE_NAME + "("
        ...
        String SQL_CREATE_COUNTRY_SERIAS_TABLE = "CREATE TABLE " + CountrySeries.TABLE_NAME + "("
        ...
        String SQL_CREATE_GANRE_SERIAS_TABLE = "CREATE TABLE " + GenreSeries.TABLE_NAME + "("
        ...
        String SQL_CREATE_PRODUCER_SERIAS_TABLE = "CREATE TABLE " + ProducerSeries.TABLE_NAME + "("
        ...
        String SQL_CREATE_WANT_TO_WATCH_SERIAS_TABLE = "CREATE TABLE " + WantToWatchSeries.TABLE_NAME + "("
        ...
        String SQL_CREATE_WATCHED_SERIAS_TABLE = "CREATE TABLE " + WatchedSeries.TABLE_NAME + "("
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        String[] tables = {
                ActorsContract.Actors.TABLE_NAME,
                ActorFilmContract.ActorFilm.TABLE_NAME,
                CountriesContract.Countries.TABLE_NAME,
                CountryFilmContract.CountryFilm.TABLE_NAME,
                FilmsContract.Films.TABLE_NAME,
                Genres.TABLE_NAME,
                GenreFilm.TABLE_NAME,
                ProducersContract.Producers.TABLE_NAME,
                ProducerFilmContract.ProducerFilm.TABLE_NAME,
                WantToWatchContract.WantToWatch.TABLE_NAME,
                WatchedContract.Watched.TABLE_NAME,
                Series.TABLE_NAME,
